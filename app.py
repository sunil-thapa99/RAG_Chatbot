...
from chatbot import *     # Import the ChatbotManager class
...
st.set_page_config(
    page_title="RAG Chatbot Interface",
    layout="wide",
...
with st.sidebar:
    ...
    # Navigation Menu
    menu = ["Chatbot"]
    choice = st.selectbox("Selection", menu)

if choice == "Chatbot":
    st.title("Chatbot Interface (Llama 3.2 RAG Model)")
    st.markdown("---")
...
# Footer
st.markdown("---")
st.markdown("<h5 style='text-align: center;'>© 2025 Chatbot RAG Assistant. All rights reserved.</h5>", unsafe_allow_html=True)